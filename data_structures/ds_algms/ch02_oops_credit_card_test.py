...
class TestCh02CreditCard(unittest.TestCase):
  ...
  def test_make_payment(self):
    ...
    if self.cc03.get_balance() == 0:
      self.cc03.charge(100)
      self.cc03.make_payment(50)
    assert self.cc03.get_balance() == 50
